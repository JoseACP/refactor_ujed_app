  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        console.error('imageContainerf obras:', e);
      } finally {
        setLoading(false);
      }
    }
  ...
  if (data.length === 0) {
    return (
      <View style={styles.empty}>
        ...
        <Text style={styles.emptyTitle}>Sin obras terminadas</Text>
        <Text style={styles.emptySub}>Las obras completadas aparecerán aquí</Text>
      </View>
    );
  }
